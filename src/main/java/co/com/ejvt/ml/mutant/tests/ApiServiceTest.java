package co.com.ejvt.ml.mutant.tests;
...
import co.com.ejvt.ml.mutant.ApiService;
import co.com.ejvt.ml.mutant.BDAccess;
import co.com.ejvt.ml.mutant.MutantAnalyzer;
import co.com.ejvt.ml.mutant.Utilidades;
...
class ApiServiceTest {
	...
	void testStringInSHA() {
		Utilidades utilidadesTester = new Utilidades();
		assertTrue(utilidadesTester
				.stringInSHA("[ \"GAGCGA\", \"TCCAAT\", \"TATACT\", \"ATAGGC\", \"CATTAC\", \"AGAAGC\" ]")
				.equals("cb94c68e28af1bef14dfd82c2b32028661d2e9b99885e86ed545a4f2c86ec9fb"));
	}
