...
class ApiServiceTest {
	...
	void testIsMutantErrorMalformado() {
		...
		assertEquals(ResponseEntity.status(HttpStatus.FORBIDDEN).body(
				...
				.getBody(), apiServiceTester.isMutant(bodyJSon4isMutantErrorMalformado).getBody());
	}
	...
	void testGetJsonArray() {
		...
		assertArrayEquals(new String[] { "ATGCGA", "CAGTGC", "TTATGT", "AGAAGG", "CCCCTA", "TCACTG" },
				utilidadesTester.getJsonArray(bodyJSon4isMutantOK));
	}
	...
	void testStringInSHA() {
		Utilidades utilidadesTester = new Utilidades();
		assertEquals("cb94c68e28af1bef14dfd82c2b32028661d2e9b99885e86ed545a4f2c86ec9fb", utilidadesTester
